...
docker run -p $DMWD_MYSQL_PORT:$DMWD_MYSQL_PORT --name mysql-main -e MYSQL_"$DMWD_MYSQL_ACCOUNT"_PASSWORD=$DMWD_MYSQL_DEFAULT_PWD -d docker pull hub.c.163.com/library/mysql:5.7.17
